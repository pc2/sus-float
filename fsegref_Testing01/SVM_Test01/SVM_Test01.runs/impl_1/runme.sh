...
HD_PWD='C:/Users/fabis/OneDrive/Dokumente/GitHub/sus-float/fsegref_Testing01/SVM_Test01/SVM_Test01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleVectorMultiply.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SimpleVectorMultiply.tcl -notrace
