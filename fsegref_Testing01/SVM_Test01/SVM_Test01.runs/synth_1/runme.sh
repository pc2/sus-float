...
HD_PWD='C:/Users/fabis/OneDrive/Dokumente/GitHub/sus-float/fsegref_Testing01/SVM_Test01/SVM_Test01.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SimpleVectorMultiply.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SimpleVectorMultiply.tcl
