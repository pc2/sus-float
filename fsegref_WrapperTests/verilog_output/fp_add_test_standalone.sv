...
/*mux_wire*/ logic  fpa_s_axis_a_tvalid;
/*mux_wire*/ logic  fpa_s_axis_b_tvalid;
...
floating_point_0 fpa(
	.aclk(clk),
	.s_axis_a_tvalid(fpa_s_axis_a_tvalid),
	.s_axis_b_tvalid(fpa_s_axis_b_tvalid),
...
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
	fpa_s_axis_a_tvalid = 'x;
	fpa_s_axis_a_tvalid = 1'b1;
end
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
	fpa_s_axis_b_tvalid = 'x;
	fpa_s_axis_b_tvalid = 1'b1;
end
always_comb begin
	// Combinatorial wires are not defined when not valid. This is just so that the synthesys tool doesn't generate latches
